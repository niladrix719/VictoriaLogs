...
* fluentbit - logs collection agent configured to collect and write data to `vlagent`
...
* victoriametrics - metrics database, which collects metrics from `fluentbit` for observability purposes
