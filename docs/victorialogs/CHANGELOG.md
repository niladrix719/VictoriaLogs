...
* BUGFIX: properly determine when the assisted merge is needed. Previously, logs for determining whether the assisted merge was needed were broken. This could lead to too many parts under a high data ingestion rate. Thanks to @lujiajing1126 for [the fix](https://github.com/VictoriaMetrics/VictoriaMetrics/pull/5447).
