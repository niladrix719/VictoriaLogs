...
* FEATURE: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): add [LogsQL](https://docs.victoriametrics.com/victorialogs/logsql/) syntax highlighting to the query editor. Field names, [pipes](https://docs.victoriametrics.com/victorialogs/logsql/#pipes), function-like filters, string literals, numbers, durations and comments are colorized. See [#1584](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1584).
