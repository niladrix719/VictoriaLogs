...
* FEATURE: [LogsQL](https://docs.victoriametrics.com/victorialogs/logsql/): add `pattern_match_prefix()` filter for matching the given [pattern](https://docs.victoriametrics.com/victorialogs/logsql/#pattern-match-filter) at the beginning of log field value. See [#762](https://github.com/VictoriaMetrics/VictoriaLogs/issues/762).
