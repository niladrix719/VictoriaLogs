...
* FEATURE: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): add a toggle for switching the order of the displayed logs by [`_time`](https://docs.victoriametrics.com/victorialogs/keyconcepts/#time-field) between newest first and oldest first. The toggle applies to the whole result set by setting the [`sort` pipe](https://docs.victoriametrics.com/victorialogs/logsql/#sort-pipe) in the executed query, and it is persisted in the URL. See [#1762](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1762).
